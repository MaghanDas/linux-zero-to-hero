...
<!-- # BREAKDOWN of ps aux output: # USER PID %CPU %MEM VSZ RSS STAT COMMAND # root 1 0.0 0.1 1234 567 Ss /sbin/init # ↑ # STAT codes: # S = sleeping # R = running # Z = zombie (dead but not cleaned up) # s = session leader # + = foreground process -->
